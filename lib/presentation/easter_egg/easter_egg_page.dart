...
class _RocketAnimationBodyState extends State<RocketAnimationBody>
  ...
  void initState() {
    ...
    //Если хотим ,чтобы ракета вернулась назад
...
//Анимация ракеты удаляющаяся вдаль
              ...
              GestureDetector(
                ...
                child: AlignTransition(
                  ...
                  child: ScaleTransition(
                    scale: rocketScaleAnimation,
                    child:
                        Image.asset(AppImages.rocketWithoutFire, height: 200),
                  ),
                ),
              ),
              Positioned(
