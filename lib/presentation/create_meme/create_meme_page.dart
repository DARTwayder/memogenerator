...
//Имплементим StatelessWidget'a и хотим переопределить параметры которые у него есть PreferredSizeWidget
            ...
            return Stack(
              children: memeTextWithOffsets.map((memeTextWithOffset) {
                return DraggableMemeText(
                  //Добавляем в метод ключ,основанный на id мемтекста
...
class _DraggableMemeTextState extends State<DraggableMemeText> {
  ...
  double calculateLeft(DragUpdateDetails details) {
    ...
    if (rawLeft > widget.parentConstraints.maxWidth - padding * 2 - 20) {
