...
class CopyUniqueFileInteractor {
  ...
  Future<String> copeUniqueFile({
    ...
    if (oldFileWithTheSameName == null) {
      //Файлов с таким именем нет. Сохраняем файл в документы
    ...
    if (indexOfLastUnderscore == -1) {
      //Файл с таким название,но с другим размером есть
    ...
    //Файл с таким название,но с другим размером есть
    //Увеличиваем число в суффикксе и сохраняем файл в документы
